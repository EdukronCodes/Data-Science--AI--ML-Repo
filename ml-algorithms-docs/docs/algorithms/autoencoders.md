...
> Comprehensive, end-to-end reference for Autoencoders. Sections follow the "Flow for Learning an ML Algorithm" format:
...
Autoencoders — description, intuition, and when to use it.

Intuition:
- High-level description of how Autoencoders maps inputs to outputs.
