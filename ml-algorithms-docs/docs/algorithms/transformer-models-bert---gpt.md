...
> Comprehensive, end-to-end reference for Transformer Models (BERT / GPT). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Transformer Models (BERT / GPT) — description, intuition, and when to use it.

Intuition:
- High-level description of how Transformer Models (BERT / GPT) maps inputs to outputs.
