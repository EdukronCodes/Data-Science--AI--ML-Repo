...
> Comprehensive, end-to-end reference for K-Nearest Neighbors (KNN). Sections follow the "Flow for Learning an ML Algorithm" format:
...
K-Nearest Neighbors (KNN) — description, intuition, and when to use it.

Intuition:
- High-level description of how K-Nearest Neighbors (KNN) maps inputs to outputs.
