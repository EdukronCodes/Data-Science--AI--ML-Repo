...
> Comprehensive, end-to-end reference for Decision Tree Classifier. Sections follow the "Flow for Learning an ML Algorithm" format:
...
Decision Tree Classifier — description, intuition, and when to use it.

Intuition:
- High-level description of how Decision Tree Classifier maps inputs to outputs.
