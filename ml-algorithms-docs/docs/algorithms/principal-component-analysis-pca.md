...
> Comprehensive, end-to-end reference for Principal Component Analysis (PCA). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Principal Component Analysis (PCA) — description, intuition, and when to use it.

Intuition:
- High-level description of how Principal Component Analysis (PCA) maps inputs to outputs.
...
- Primary problem type: Dimensionality Reduction
