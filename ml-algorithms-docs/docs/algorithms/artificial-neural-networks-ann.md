...
> Comprehensive, end-to-end reference for Artificial Neural Networks (ANN). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Artificial Neural Networks (ANN) — description, intuition, and when to use it.

Intuition:
- High-level description of how Artificial Neural Networks (ANN) maps inputs to outputs.
