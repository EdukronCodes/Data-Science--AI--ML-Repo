...
> Comprehensive, end-to-end reference for Recurrent Neural Networks (RNN). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Recurrent Neural Networks (RNN) — description, intuition, and when to use it.

Intuition:
- High-level description of how Recurrent Neural Networks (RNN) maps inputs to outputs.
