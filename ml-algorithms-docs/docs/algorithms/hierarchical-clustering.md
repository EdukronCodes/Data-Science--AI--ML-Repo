...
> Comprehensive, end-to-end reference for Hierarchical Clustering. Sections follow the "Flow for Learning an ML Algorithm" format:
...
Hierarchical Clustering — description, intuition, and when to use it.

Intuition:
- High-level description of how Hierarchical Clustering maps inputs to outputs.
