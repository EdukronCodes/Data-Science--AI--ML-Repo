...
> Comprehensive, end-to-end reference for Label Propagation / Label Spreading. Sections follow the "Flow for Learning an ML Algorithm" format:
...
Label Propagation / Label Spreading — description, intuition, and when to use it.

Intuition:
- High-level description of how Label Propagation / Label Spreading maps inputs to outputs.
...
- Primary problem type: Semi-Supervised
