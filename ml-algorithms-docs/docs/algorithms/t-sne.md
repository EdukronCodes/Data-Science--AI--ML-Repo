...
> Comprehensive, end-to-end reference for t-SNE. Sections follow the "Flow for Learning an ML Algorithm" format:
...
t-SNE — description, intuition, and when to use it.

Intuition:
- High-level description of how t-SNE maps inputs to outputs.
