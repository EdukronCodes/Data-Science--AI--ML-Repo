...
> Comprehensive, end-to-end reference for Naïve Bayes. Sections follow the "Flow for Learning an ML Algorithm" format:
...
Naïve Bayes — description, intuition, and when to use it.

Intuition:
- High-level description of how Naïve Bayes maps inputs to outputs.
