...
> Comprehensive, end-to-end reference for DBSCAN. Sections follow the "Flow for Learning an ML Algorithm" format:
...
DBSCAN — description, intuition, and when to use it.

Intuition:
- High-level description of how DBSCAN maps inputs to outputs.
