...
> Comprehensive, end-to-end reference for Gaussian Mixture Models (GMM). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Gaussian Mixture Models (GMM) — description, intuition, and when to use it.

Intuition:
- High-level description of how Gaussian Mixture Models (GMM) maps inputs to outputs.
...
- Primary problem type: Clustering
