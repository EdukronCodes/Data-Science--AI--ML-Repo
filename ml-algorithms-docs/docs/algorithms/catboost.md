...
> Comprehensive, end-to-end reference for CatBoost. Sections follow the "Flow for Learning an ML Algorithm" format:
...
CatBoost — description, intuition, and when to use it.

Intuition:
- High-level description of how CatBoost maps inputs to outputs.
