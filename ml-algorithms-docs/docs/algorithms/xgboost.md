...
> Comprehensive, end-to-end reference for XGBoost. Sections follow the "Flow for Learning an ML Algorithm" format:
...
XGBoost — description, intuition, and when to use it.

Intuition:
- High-level description of how XGBoost maps inputs to outputs.
