...
> Comprehensive, end-to-end reference for Convolutional Neural Networks (CNN). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Convolutional Neural Networks (CNN) — description, intuition, and when to use it.

Intuition:
- High-level description of how Convolutional Neural Networks (CNN) maps inputs to outputs.
...
- Primary problem type: General/Deep Learning
