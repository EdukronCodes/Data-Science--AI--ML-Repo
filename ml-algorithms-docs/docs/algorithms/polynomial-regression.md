...
> Comprehensive, end-to-end reference for Polynomial Regression. Sections follow the "Flow for Learning an ML Algorithm" format:
...
Polynomial Regression — description, intuition, and when to use it.

Intuition:
- High-level description of how Polynomial Regression maps inputs to outputs.
