...
> Comprehensive, end-to-end reference for Support Vector Regression (SVR). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Support Vector Regression (SVR) — description, intuition, and when to use it.

Intuition:
- High-level description of how Support Vector Regression (SVR) maps inputs to outputs.
