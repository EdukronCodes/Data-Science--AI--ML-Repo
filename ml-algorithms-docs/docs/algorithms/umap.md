...
> Comprehensive, end-to-end reference for UMAP. Sections follow the "Flow for Learning an ML Algorithm" format:
...
UMAP — description, intuition, and when to use it.

Intuition:
- High-level description of how UMAP maps inputs to outputs.
