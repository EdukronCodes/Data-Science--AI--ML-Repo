...
> Comprehensive, end-to-end reference for Support Vector Machine (SVM). Sections follow the "Flow for Learning an ML Algorithm" format:
...
Support Vector Machine (SVM) — description, intuition, and when to use it.

Intuition:
- High-level description of how Support Vector Machine (SVM) maps inputs to outputs.
